...
function Nav() {
  ...
  const beneficiaryAllowedLinks = [
    "/user/beneficiary/details",
    "/user/beneficiary",
    "/user/create/beneficiary",
    "/user/beneficiary/upload",
  ];
  ...
  return (
    <NavCont>
      <NavContent>
        ...
        <Icon
          className={
            beneficiaryAllowedLinks.includes(window?.location?.pathname)
              ? "active"
              : "inactive"
          }
          onClick={() => navigate("/user/beneficiary")}
        >
          <svg
            width="33"
            height="46"
            viewBox="0 0 24 24"
            fill={
              window.location.pathname === "/user/beneficiary"
                ? "#00A85A"
                : "none"
            }
            xmlns="http://www.w3.org/2000/svg"
        ...
        >
          ...
          >
            ...
            <g clip-path="url(#clip0_148_18558)">
              <path
                d="M19.75 28.6123V33.2503C19.75 33.5743 19.958 33.8613 20.266 33.9633C20.343 33.9883 20.422 34.0003 20.5 34.0003C20.734 34.0003 20.96 33.8903 21.104 33.6943L23.817 30.0023L19.75 28.6123Z"
                fill="white"
              />
              <path
                d="M34.685 11.1391C34.455 10.9761 34.153 10.9541 33.903 11.0851L11.403 22.8351C11.137 22.9741 10.98 23.2581 11.002 23.5571C11.025 23.8571 11.224 24.1131 11.507 24.2101L17.762 26.3481L31.083 14.9581L20.775 27.3771L31.258 30.9601C31.336 30.9861 31.418 31.0001 31.5 31.0001C31.636 31.0001 31.771 30.9631 31.89 30.8911C32.08 30.7751 32.209 30.5801 32.242 30.3611L34.992 11.8611C35.033 11.5811 34.915 11.3031 34.685 11.1391Z"
                fill="white"
              />
            </g>
            <defs>
        ...
        >
          ...
          >
            <path
              ...
              fill={
                window.location.pathname === "/settings" ? "#00A85A" : "#909090"
              }
            />
          </svg>
          <p>Settings</p>
